class BankAccount:
    ...
    def cont_bancar(self, iban, adresa, cont_economii, cont_credit):
        print(
            f' Hi: {self._user}, Ibanul dv: {iban}, Pin: {self._pwd}, Adresa dv: {adresa}, {cont_economii}, {cont_credit}')
        return 'cont_activ'
...
bank_account_John = BankAccount(user, pwd)
bank_account_Marry = BankAccount('Marry', '2222')
bank_account_John.cont_bancar('Ro100BTRL', 'Str. Raiului nr 12, Bucuresti', 'RO1200BTRL',
                              'RO130000BTRL')
bank_account_Marry.cont_bancar('R01123123100BTRL', 'Str. AAAAAAARaiului nr 21312, Bucuresti',
                               'RRRRRO1200BTRL', 'RO130000BTRL')
